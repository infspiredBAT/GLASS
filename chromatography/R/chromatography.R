...
chromatography <- function(intens, intens_rev = NULL, intrexdat, calls, choices, new_sample, noisy_neighbors, show_calls = FALSE,qual_present,brush_fw,brush_rv, width = NULL, height = NULL) {
